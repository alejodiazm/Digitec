...
export const Hero = () => {
    return (
        <section id="inicio" className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-[#F8FAFC]">
            ...
            {/* Background Light Effect (z-10) */}
            <div className="absolute inset-x-0 top-0 z-10 w-full pointer-events-none">
                <Lamp className="h-full" />
            </div>

            {/* Foreground Content (z-20) */}
            <Container className="relative z-20 pt-32 md:pt-48 pb-20 md:pb-32 flex flex-col items-center text-center max-w-4xl mx-auto space-y-8">
                {/* Badge */}
                <ScrollReveal>
